...
[![Test](https://github.com/NpoolPlatform/subscribe-manager/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/subscribe-manager/actions/workflows/main.yml)
...
* make subscribe-manager ```单独编译服务```
* make subscribe-manager-image ```单独生成服务镜像```
